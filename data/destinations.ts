...
export const DESTINATIONS: Destination[] = src([
  ...
  {
    key: "side",
    name: SIDE.name ?? { en: "Side", fr: "Side" },
    country: SIDE.country ?? { en: "Turkey", fr: "Turquie" },
    inPhrase: { en: "in Side", fr: "à Side" },
    slug: { en: "family-hotels-side", fr: "hotels-famille-side" },
    geo: SIDE.geo ?? { lat: 36.767, lng: 31.389, zoom: 11 },
    heroKicker: SIDE.heroKicker ?? {
      en: "All-inclusive family resorts with aquaparks and free kids clubs",
      fr: "Des resorts all-inclusive famille avec aquaparcs et clubs enfants gratuits",
    },
    intro: SIDE.intro ?? { en: "", fr: "" },
    whyKids: SIDE.whyKids ?? { en: [], fr: [] },
    bestAreas: SIDE.bestAreas ?? { en: [], fr: [] },
    emoji: SIDE.emoji ?? "🌊",
    accent: SIDE.accent ?? "0e8f9e",
    hotelKeys: [],
    related: ["belek", "antalya", "guide-allinclusive-europe", "guide-waterslide-hotels"],
    photos: SIDE.photos,
    stats: SIDE.stats,

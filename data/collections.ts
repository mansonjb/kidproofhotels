...
export const COLLECTIONS: Collection[] = src([
  {
    ...
    select: { destinationKeys: ["tenerife", "gran-canaria", "fuerteventura", "lanzarote", "costa-del-sol", "madeira", "hurghada", "sharm", "sal"], limit: 12 },
    faqs: [
      {
  ...
  },
  {
    ...
    select: { destinationKeys: ["tenerife", "gran-canaria", "fuerteventura", "lanzarote", "algarve", "costa-del-sol", "crete", "cyprus", "malta", "madeira", "hurghada", "sousse", "sharm", "bodrum", "sal"], limit: 12 },
    faqs: [
      {

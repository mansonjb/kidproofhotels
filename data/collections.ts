...
export const COLLECTIONS: Collection[] = src([
  {
    ...
    select: { destinationKeys: ["tenerife", "gran-canaria", "fuerteventura", "lanzarote", "costa-del-sol", "madeira", "hurghada", "sharm", "sal", "saint-martin", "dubai", "martinique", "guadeloupe", "la-palma", "agadir", "djerba", "costa-almeria", "punta-cana"], limit: 12 },
    faqs: [
      {
  ...
  },
  {
    ...
    select: { destinationKeys: ["tenerife", "gran-canaria", "fuerteventura", "lanzarote", "algarve", "costa-del-sol", "crete", "cyprus", "malta", "madeira", "hurghada", "sousse", "sharm", "bodrum", "sal", "saint-martin", "dubai", "martinique", "guadeloupe", "la-palma", "agadir", "djerba", "costa-de-la-luz", "mauritius", "costa-almeria"], limit: 12 },
    faqs: [
      {

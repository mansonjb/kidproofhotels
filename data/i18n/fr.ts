...
export const UI_FR: Dict = {
  ...
  browse: {
    ...
    comboIntro: "Les meilleurs hôtels famille {dest} pour exactement ça, classés par Score KidProof et comparés côte à côte, avec les compromis honnêtes qu'un parent veut avant de réserver.",
    comboIntroFacts: "{count} hôtels famille {dest}, filtrés sur le critère {amenity} et classés par Score KidProof. {top} arrive en tête, et nous détaillons les vrais compromis avant de réserver.",
    comboAreas: "La plupart des familles s'installent près de {area}.",

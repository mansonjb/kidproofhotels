...
import costaLuz from "./costa-de-la-luz.json";
...
import marMenor from "./mar-menor.json";
import naxosParos from "./naxos-paros.json";
import costaNavarino from "./costa-navarino.json";
import marsaAlam from "./marsa-alam.json";
...
import cancun from "./cancun.json";
import corsica from "./corsica.json";
import orlando from "./orlando.json";
import thassos from "./thassos.json";
...
import seychelles from "./seychelles.json";
import phuket from "./phuket.json";
import bali from "./bali.json";
import zanzibar from "./zanzibar.json";
import rasAlKhaimah from "./ras-al-khaimah.json";
...
const FILES = [lisbon, algarve, costa, mallorca, tenerife, crete, antalya, sardinia, costaBlanca, rhodes, granCanaria, cyprus, sicily, corfu, fuerteventura, barcelona, lanzarote, menorca, kos, valencia, malta, zakynthos, madeira, costaDorada, seville, halkidiki, puglia, hurghada, sousse, sharm, bodrum, sal, reunion, saintMartin, dubai, martinique, guadeloupe, ibiza, laPalma, agadir, lakeGarda, frenchRiviera, costaBrava, djerba, marrakech, costaLuz, mauritius, istria, costaAlmeria, puntaCana, frenchAlps, marMenor, naxosParos, costaNavarino, marsaAlam, hammamet, rivieraMaya, kefalonia, rimini, belek, abuDhabi, disneylandParis, alula, jeddah, maldives, seychelles, phuket, bali, zanzibar, rasAlKhaimah, side, cancun, corsica, orlando, thassos] as unknown as SeedFile[];
...
export const DJERBA_META = (djerba as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const MARRAKECH_META = (marrakech as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const COSTA_LUZ_META = (costaLuz as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const MAURITIUS_META = (mauritius as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const ISTRIA_META = (istria as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const COSTA_ALMERIA_META = (costaAlmeria as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
...
export const FRENCH_ALPS_META = (frenchAlps as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const MAR_MENOR_META = (marMenor as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const NAXOS_PAROS_META = (naxosParos as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const COSTA_NAVARINO_META = (costaNavarino as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const MARSA_ALAM_META = (marsaAlam as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const HAMMAMET_META = (hammamet as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const RIVIERA_MAYA_META = (rivieraMaya as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
...
export const SIDE_META = (side as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const CANCUN_META = (cancun as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const CORSICA_META = (corsica as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const ORLANDO_META = (orlando as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const THASSOS_META = (thassos as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const ABU_DHABI_META = (abuDhabi as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const DISNEYLAND_PARIS_META = (disneylandParis as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const ALULA_META = (alula as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const JEDDAH_META = (jeddah as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const MALDIVES_META = (maldives as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;

export const SEYCHELLES_META = (seychelles as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;

export const PHUKET_META = (phuket as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;

export const BALI_META = (bali as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;

export const ZANZIBAR_META = (zanzibar as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;
export const RAS_AL_KHAIMAH_META = (rasAlKhaimah as unknown as SeedFile).destinationMeta as
  | Record<string, unknown>
  | undefined;

...
const FILES = ["lisbon.json", "algarve.json", "costa-del-sol.json", "mallorca.json", "tenerife.json", "crete.json", "antalya.json", "sardinia.json", "costa-blanca.json", "rhodes.json", "gran-canaria.json", "cyprus.json", "sicily.json", "corfu.json", "fuerteventura.json", "barcelona.json", "lanzarote.json", "menorca.json", "kos.json", "valencia.json", "malta.json", "zakynthos.json", "madeira.json", "costa-dorada.json", "seville.json", "halkidiki.json", "puglia.json", "hurghada.json", "sousse.json", "sharm.json", "bodrum.json", "sal.json", "reunion.json", "martinique.json", "guadeloupe.json", "saint-martin.json", "dubai.json", "la-palma.json", "ibiza.json", "agadir.json", "lake-garda.json", "french-riviera.json", "costa-brava.json", "djerba.json", "marrakech.json", "costa-de-la-luz.json", "mauritius.json", "istria.json", "costa-almeria.json", "punta-cana.json", "french-alps.json", "mar-menor.json", "naxos-paros.json", "costa-navarino.json", "marsa-alam.json", "hammamet.json", "riviera-maya.json", "kefalonia.json", "rimini.json", "belek.json", "abu-dhabi.json", "disneyland-paris.json", "alula.json", "jeddah.json", "maldives.json", "seychelles.json", "phuket.json", "bali.json", "zanzibar.json", "ras-al-khaimah.json", "side.json", "cancun.json", "corsica.json", "orlando.json", "thassos.json"];

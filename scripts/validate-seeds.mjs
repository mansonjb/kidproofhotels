...
const FILES = ["lisbon.json", "algarve.json", "costa-del-sol.json", "mallorca.json", "tenerife.json", "crete.json", "antalya.json", "sardinia.json", "costa-blanca.json", "rhodes.json", "gran-canaria.json", "cyprus.json", "sicily.json", "corfu.json", "fuerteventura.json", "barcelona.json", "lanzarote.json", "menorca.json", "kos.json"];
